...
/**
 * Unit tests for RealS3ClientResolver.
 */
class RealS3ClientResolverTest {

  @Test
  @SuppressWarnings("unchecked")
  void supportsParameter_withS3Client_returnsTrue() throws ParameterResolutionException {
    RealS3ClientResolver resolver = new RealS3ClientResolver();
  ...
  @Test
  @SuppressWarnings("unchecked")
  void supportsParameter_withS3VectorsClient_returnsFalse() throws ParameterResolutionException {
    RealS3ClientResolver resolver = new RealS3ClientResolver();
    ParameterContext parameterContext = mock(ParameterContext.class);
    ExtensionContext extensionContext = mock(ExtensionContext.class);
    java.lang.reflect.Parameter parameter = mock(java.lang.reflect.Parameter.class);
  ...
  @Test
  void createClient_withBasicConfiguration_createsS3Client() {
    ...
    assertDoesNotThrow(s3Client::close);
  ...
  @Test
  void createClient_withCustomEndpoint_createsS3ClientWithEndpoint() {
    System.setProperty(AbstractRealS3ParameterResolver.AWS_ACCESS_KEY_ENV, "fake-access-key");
    System.setProperty(AbstractRealS3ParameterResolver.AWS_SECRET_KEY_ENV, "fake-secret-key");
  ...
  @Test
  void createClient_withCredentials_createsS3Client() {
    RealS3ClientResolver resolver = new RealS3ClientResolver();
  ...
  @Test
  void createClient_withSessionToken_createsS3Client() {
    RealS3ClientResolver resolver = new RealS3ClientResolver();
  ...
  @Test
  void createClient_withPathStyleAccess_createsS3Client() {
    System.setProperty(AbstractRealS3ParameterResolver.AWS_ACCESS_KEY_ENV, "fake-access-key");
    System.setProperty(AbstractRealS3ParameterResolver.AWS_SECRET_KEY_ENV, "fake-secret-key");
  ...
  @Test
  void createClient_withPathStyleAccessAndCustomEndpoint_createsS3Client() {
    System.setProperty(AbstractRealS3ParameterResolver.AWS_ACCESS_KEY_ENV, "fake-access-key");
    System.setProperty(AbstractRealS3ParameterResolver.AWS_SECRET_KEY_ENV, "fake-secret-key");
    
    RealS3ClientResolver resolver = new RealS3ClientResolver();
    String customEndpoint = "https://localhost:9000";
    RealS3 config = createMockRealS3Config("us-east-1", "", "", "", customEndpoint, true);
  ...
  @Test
  void integrationTest_withRealS3Annotation_injectsS3Client(S3Client client) {
    assertNotNull(client);
    assertInstanceOf(S3Client.class, client);
  }

  /**
   * Integration test with custom endpoint and path style access
   */
  @RealS3(region = "us-west-2", endpointUrl = "https://s3.us-west-2.amazonaws.com", pathStyleAccess = true)
  @Test
  void integrationTest_withCustomEndpointAndPathStyle_injectsS3Client(S3Client client) {
    assertNotNull(client);
    assertInstanceOf(S3Client.class, client);
  }
